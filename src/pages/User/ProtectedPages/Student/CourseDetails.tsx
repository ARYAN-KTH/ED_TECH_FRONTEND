                ...
                <CardContent className="p-6">
                  <div className="prose max-w-none">
                    ...
                    <p>
                      ...
                      existing skills, this course provides the perfect balance
                  ...
                  <div className="flex flex-col md:flex-row items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        An experienced instructor with over 10 years of industry
                        experience. Passionate about teaching and helping
            ...
            <CardContent className="p-0">
              ...
              <div className="p-6">
                ...
                <Button
                  ...
                  disabled={enrolledCourse}
                >
                  { enrolledCourse? "Enrolling" :"Enroll in Course" }
                </Button>
